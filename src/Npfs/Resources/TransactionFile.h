...
//  ResultMessage modifyStat(Npfs::BlockingOpState* &opRef, const Npfs::NpStat& wstat); // the default implementation modifies stat according the rules from 9P
  ...
  void setBeginHandler(const Callback<bool, typename SerDes::VarType&, bool&, const char*&, void*>* handler, void* ref = ~uintptr_t(0)); ///< the given handler will be executed on opening the file, until it returns true, second arg is true if file is opened for write, third arg is returned error msg, if not nullptr, may be set false to deny write access
  void setAbortHandler(const Callback<bool, typename SerDes::VarType&, bool, const char*&, void*>* handler, void* ref = ~uintptr_t(0)); ///< the given handler will be executed once on closing the file with flush(), return value will be ignored, second arg is true, if file was opened for write, third arg is ignored, return value is ignored
  void setCommitHandler(const Callback<bool, typename SerDes::VarType&, bool, const char*&, void*>* handler, void* ref = ~uintptr_t(0)); ///< the given handler will be executed on closing the file, if the file was opened for write, just before the endHandler, until it returns true, second arg is true, if file was actually written to, third arg is returned error msg, if not nullptr
  void setEndHandler(const Callback<bool, typename SerDes::VarType&, bool, const char*&, void*>* handler, void* ref = ~uintptr_t(0)); ///< the given handler will be executed on closing the file, until it returns true, second arg is true if file was opened for write, third arg is returned error msg, if not nullptr

protected:
  const Callback<bool, typename SerDes::VarType&, bool&, const char*&, void*>* beginTxnHandler;
  void* beginTxnRef;
  ...
  PT_THREAD(openCoRoutine(ResultMessage& result, Npfs::OpenIoState& workRef));
...
template<class SerDes>
void TransactionFile<SerDes>::setBeginHandler(const Callback<bool, typename SerDes::VarType&, bool&, const char*&, void*>* handler, void* ref)
{
